...
plt.figure()
plt.plot(t, tensions, lw=0.5, label=['$v_e$', '$Ri_s$'])
plt.grid('on')
...
plt.figure()
plt.plot(t, courants, lw=0.5, label=[
         'signal de commande', '$i_1$', '$i_s$', '$i_c$'])
plt.grid('on')
...
plt.figure()
plt.plot(t[ind_extr], tensions[ind_extr, :], label=['$v_e$', '$R i_s$'])
plt.grid('on')
plt.title('Tensions (en V)')
plt.xlabel('temps (en s)')
plt.legend()
...
plt.figure()
plt.plot(t[ind_extr], courants[ind_extr, :], label=[
         'signal de commande', '$i_1$', '$i_s$', '$i_c$'])
plt.grid('on')
plt.title('Courants (en A)')
plt.xlabel('temps (en s)')
